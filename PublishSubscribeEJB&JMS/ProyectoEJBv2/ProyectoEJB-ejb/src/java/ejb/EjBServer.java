...
public class EjBServer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Noticias</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            out.println(ejbSessionBean.getNumber()+1 + " noticias:");
            out.println("<br><br>"); // 2 saltos de linea
            for (int i=0;i<=ejbSessionBean.getNumber();i++) {
                out.println(ejbSessionBean.getList().get(i));
                out.println("<br>");
            }
            out.println("<a href='PublishMessage'> Publicar noticia</a>");
            out.println("<br><br>"); // 2 saltos de linea
