...
public class Piece {
	...
	public ArrayList<Action> getHorizontalLeftMoves(State s, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(100);
		int agente_color = this.color;
		Position posicion = new Position(row, col);
		...
		for (int c = c0-1; (c >= 0) && (!busyCell); c--) {
			if (s.m_board[r0][c] == Utils.empty) {
				action = new Action(posicion, new Position(r0, c));
				list.add(action);
			} else {
				busyCell = true;
	...
	public ArrayList<Action> getHorizontalRightMoves(State s, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(100);
		int agente_color = this.color;
		int c0, r0;
		Position posicion = new Position(row, col);
	...
	// vertical down moves
	public ArrayList<Action> getVerticalDownMoves(State state, int row, int col) {
		...
		for (int r = r0 + 1; (r < state.m_boardSize) && (!busyCell); r++) {
			if (state.m_board[r][c0] == Utils.empty) {// add action
				action = new Action(posicion, new Position(r, c0));
				list.add(action);
			} else {
				busyCell = true;
	...
	// vertical up moves
	public ArrayList<Action> getVerticalUpMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.color;
	 ...
	 */
	// up-right diagonal
	public ArrayList<Action> getUpRightDiagonalMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.color;
		...
		for (int r = r0 + 1, c = c0 - 1; (c >= 0) && (r < state.m_boardSize) && !busyCell; r++, c--) {
				if (state.m_board[r][c] == Utils.empty) {// add action
					action = new Action(posicion, new Position(r, c));
					list.add(action);
				} else {
					busyCell = true;
	...
	public ArrayList<Action> getUpLeftDiagonalMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.color;
	...
	public ArrayList<Action> getDownRightDiagonalMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.color;
	...
	public ArrayList<Action> getDownLeftDiagonalMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.color;
	...
	public ArrayList<Action> upKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		...
		if(r0>=1) {
			if (state.m_board[r0 - 1][c0] == Utils.empty) { // movimiento normal de una posicion
				list.add(new Action(posicion, new Position(r0 - 1, c0)));
			}
	...
	public ArrayList<Action> downKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> rightKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		...
		if(c0<state.m_boardSize-1) {
			if (state.m_board[r0][c0+1] == Utils.empty) { // movimiento normal de una posicion
				list.add(new Action(posicion, new Position(r0, c0+1)));
			}
	...
	public ArrayList<Action> leftKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> upLeftKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		...
		if(c0>=1 && r0>=1) {
			if (state.m_board[r0-1][c0-1] == Utils.empty) { // movimiento normal de una posicion
				list.add(new Action(posicion, new Position(r0-1, c0-1)));
			}
	...
	public ArrayList<Action> downLeftKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> upRightKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> downRightKingMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> twoRightOneUpKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		...
		if(r0<state.m_boardSize-2 && c0>=1) {
			if (state.m_board[r0+2][c0-1] == Utils.empty) { // movimiento normal de una posicion
				list.add(new Action(posicion, new Position(r0+2, c0-1)));
			}
	...
	public ArrayList<Action> oneRightTwoUpKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
		...
		if(r0>state.m_boardSize-1 && c0>=2) {
			if (state.m_board[r0+1][c0-2] == Utils.empty) { // movimiento normal de una posicion
				list.add(new Action(posicion, new Position(r0+1, c0-2)));
			}
	...
	public ArrayList<Action> oneLeftTwoUpKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> twoLeftOneUpKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> oneLeftTwoDownKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> twoLeftOneDownKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> twoRightOneDownKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
	...
	public ArrayList<Action> oneRightTwoDownKnightMoves(State state, int row, int col) {
		ArrayList<Action> list = new ArrayList<Action>(10);
