...
public class CosteUniforme {
	...
	public static final Comparator<Nodo> porCoste = new Nodo.evaluadorCoste();
	long nodosGenerados=0;
	long tiempoBusqueda;

	CosteUniforme(State si, int semilla){
	...
	public void busqueda() {
		...
		PriorityQueue<Nodo> frontera = new PriorityQueue<Nodo>(porCoste);
	...
	public static void main(String[] args) {
		...
		CosteUniforme srs = new CosteUniforme(state,seed2);
		srs.agente.color=0;
		srs.busqueda();
